...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`header left-0 top-0 z-40 grid w-full items-center ${
          sticky
            ? "fixed z-[9999] bg-white !bg-opacity-80 shadow-sticky backdrop-blur-sm transition"
            : "absolute bg-transparent"
        }`}
      >
        <div className="bg-sky-700 w-full px-4 py-3 text-white">
          <div className="container text-center text-sm font-medium">
            <Link href="/campaign/zakat">
              <strong className="inline-block">Tunaikan Kewajiban Zakat</strong>
